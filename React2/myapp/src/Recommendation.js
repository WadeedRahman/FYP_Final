...
import { RiEraserFill,  RiCornerUpLeftDoubleLine } from 'react-icons/ri';
...
function Description() {
  ...
  return (
    <div className='Ai'>
      ...
      <RiCornerUpLeftDoubleLine className='arro' onClick={handleBackClick} />
        ...
        />
         <div className='bun' onClick={clearMessages}>
          <RiEraserFill />
        </div> 
      </div>
    </div>
